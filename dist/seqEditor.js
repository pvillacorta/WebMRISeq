...
var ASM_CONSTS = {
  16241992: ($0, $1, $2) => { var tempFileName = $2 + ".qml"; var stream = FS.open(tempFileName,'w'); var dataPtr = $0; var dataSize = $1; FS.write(stream, HEAPU8, dataPtr, dataSize, 0); FS.close(stream); }
};
function plot_sequence(model) { plot_seq(UTF8ToString(model)); }
...
var ___start_em_js = Module['___start_em_js'] = 16241452;
var ___stop_em_js = Module['___stop_em_js'] = 16241992;
