...
wasmBinaryFile = "dynamic/appWebMRISeq.wasm";
...
var ASM_CONSTS = {
 16345476: ($0, $1, $2) => {
  ...
  var dataPtr = $0;
  var dataSize = $1;
  FS.write(stream, GROWABLE_HEAP_U8(), dataPtr, dataSize, 0);
  FS.close(stream);
 }
};

function plot_sequence(model) {
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var worker;
  var pthreadMainJs = locateFile("appWebMRISeq.worker.js");
...
var ___start_em_js = Module["___start_em_js"] = 16344936;

var ___stop_em_js = Module["___stop_em_js"] = 16345476;
